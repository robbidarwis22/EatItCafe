...
//    private final int PICK_IMAGE_REQUEST = 71;
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Tambah Kategori Baru");
        alertDialog.setMessage("Masukkan Informasi Secara Lengkap ");
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //send Category ID dan mulai aktivity
    ...
    private void deleteCategory(String key) {
        ...
        Toast.makeText(this,"kehapus....", Toast.LENGTH_SHORT).show();
    }
    ...
    private void changeImage(final Category item) {
        if (saveUri != null){
            final ProgressDialog mDialog = new ProgressDialog(this);
            mDialog.setMessage("Mengunduh bos ......");
            mDialog.show();
